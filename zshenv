...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    export JAVA_HOME="$WINAPPS_HOME\\java\\zulu7.38.0.11-ca-jdk7.0.262-win_x64"
    #export JAVA_HOME="C:\\Program Files\\Java\\jdk1.8.0_152"
    export ANT_HOME="$WINAPPS_HOME\\java\\apache-ant-1.9.15"
    export MAVEN_HOME="$WINAPPS_HOME\\Java\\apache-maven-3.6.3"
